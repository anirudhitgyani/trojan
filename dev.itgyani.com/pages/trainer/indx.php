...
<div class="form-group"><label> Upload Resume: </label><input name="corporate_logo" id="corporate_logo" type="file" class="form-input" value="" /></div>
<h5 id="error_logo" style="color:red; display:none;" >Please Upload Resume...</h5>
...
<input type="submit" onclick="RegisterForm();" class="blue-buttons submit-button" value="Submit" />
