...
<div class="container">    
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-5 col-md-offset-4 col-sm-8 col-sm-offset-3">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title text-center formtitle">Corporate Login</div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form action="javascript:void(0);" id="cor_login_form" method="post" class="form-horizontal">
                            <input type="hidden" name="action" id="action" value="login"  />
                                    
                            <div id="formtext1" style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                                <input type="text" class="form-control" name="user_name" id="user_name" value="" placeholder="Email" value="" >                                        
                            </div>
                            ...
                            <div class="forgottext graytxt">Forgot Password <a href="<?php echo $RootPath; ?>pages/corporate/forgot_password.php">Click here</a></div>
							  
                            <input type="button" onclick="LoginForm();" class="btn btn-default-1 pull-right" value="SIGN IN" />
                                ...
                                <div style="margin-top:10px" class="form-group row">
                                    <!-- Button -->
                                     ...
                                     <div class="col-md-12">
                                         <span class="graytxt">Don't have login</span>
										<div class="pull-right" id="regi">
											<i class="fa fa-pencil" aria-hidden="true"></i>
											<a id="btn-login" href="<?php echo $RootPath; ?>pages/corporate/registration.php" class="btn btn-default-1">REGISTER HERE</a>
										</div>
									 </div>
									<div class="clearfix"></div>
