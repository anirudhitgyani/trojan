...
<h1>Dashboard</h1>
<p>Welcome back <?php echo $row_user['ProfileFirstName']; ?></p>
</div>
</div></div>
...
<img height="90px;" width="90px;" style="border-radius: 45px;"  src="<?php echo $RootPath; ?>images/corporatelogos/<?php echo $row_user['ProfilePicture']; ?>" />
<?php } else { ?>
