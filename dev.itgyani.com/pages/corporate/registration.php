        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-9 col-md-offset-2 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    <div class="panel-heading">
                        <div class="panel-title text-center formtitle">Corporate Registration</div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form action="javascript:void(0);" method="post" id="cor_regi_form" class="form-horizontal" role="form">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="formtext1" style="margin-bottom: 25px" class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    <input id="company_name" type="text" class="form-control" name="company_name" placeholder="Company Name" onblur="if($('#company_name').val()=='') { $('#company_name').css('border','1px solid red'); } else { $('#company_name').css('border','1px solid #ccc'); }"  >
                                </div> 
                            ...
                            <div class="col-md-8 pull-right">
                                    ...
                                    <input type="button" id="reg_submit_button" onclick="RegisterForm();" class="btn btn-default-1 pull-right" value="SIGN UP" />
                                    </div>
                                    ...
                                    <!-- Button -->
									 ...
									 <div class="col-md-8 col-xs-12">
										...
										<i class="fa fa-credit-card-alt" aria-hidden="true"></i>
											<a id="btn-fblogin" href="<?php echo $RootPath; ?>pages/corporate/" class="btn btn-default-1">LOGIN</a>
										</div>
									 </div>
                                </div>
                                ...
                                <p id="error_company_name" style="color:red; display:none;" >Please Enter Only Text in Company Name</p>
