...
<div class="refer-frd">
<div class="dark-refer">
<h3>Refer a friend </h3>
<form>
<input type="email" class="form-control" placeholder="Email" />
<input type="password" class="form-control" placeholder="Password" />
<input type="submit" class="white-butts" value="Invite" />
</form>
<div class="social-login text-center"><a href="#" class="facebook"><i class="fa fa-facebook"></i></a><a href="#" class="google-plus"><i class="fa fa-google-plus"></i></a></div>
</div>
</div>
</div>
</div>
