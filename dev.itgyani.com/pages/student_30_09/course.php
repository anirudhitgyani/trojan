                    ...
                    <?php } else { ?>
                        <?php if($videoURL!='') { ?>
                            <?php if($videoLocked=='1') { ?>
                                <li>
                                    <a href="<?php echo $RootPath; ?>pages/student/dashboard.php?CourseID=<?php echo $row_course['CourseID']; ?>&TopicID=<?php echo $row_topic['TopicID']; ?>"><img class="img-responsive" src="<?php echo $thumbURL; ?>" >
