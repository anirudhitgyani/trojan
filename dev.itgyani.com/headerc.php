...
<div class="container v-center" style="position:relative;"><a href="<?php echo $RootPath; ?>" class="r-menus blue-back">Home</a>
<a class="logo salman" href="<?php echo $RootPath; ?>"><img src="<?php echo $RootPath; ?>images/logo.png" /></a></br></br><h1>DISCOVER.CHOOSE.KNOW.</h1>
<p1>Get Floor Ready Candidates Here</p1>
</div>
