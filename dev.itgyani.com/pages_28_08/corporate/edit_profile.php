...
<form action="<?php echo $RootPath; ?>action/corporate.php" method="post" id="image_form" enctype="multipart/form-data" >
 <input type="hidden" name="action" id="action" value="change_image" />
<div class="col-sm-2 col-md-2 col-xs-12 text-center">
<div class="avtar-box">
<div class="avtar-image">
	<?php if($row_user['ProfilePicture']!='') { ?>
    	<img id="img1" src="<?php echo $RootPath; ?>upload_images/hr_images/<?php echo $row_user['ProfilePicture']; ?>" />
	<?php } else { ?>
    	<img id="img1" src="<?php echo $RootPath; ?>images/avtar-image.png" />
    <?php } ?>
</div><br/>
<a onclick="OpenBrowser();" href="javascript:void(0);">Edit</a> / <a onclick="ChangeImage();" href="javascript:void(0);">Uploads</a>
...
<!--        <div class="col-xs-12 col-md-3 col-sm-3">
 ...
 <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-12 col-md-4 col-sm-3">
            <input type="text" class="form-control" id="ProfilePincode" name="ProfilePincode" placeholder="Enter Pin Coe" value="<?php echo $row_user['ProfilePincode']; ?>" >
...
function EditProfile(){
	...
	if($('#ProfileName').val()==''){
		...
		$('#ProfileName').css('border','1px solid #c4dee7');
	}
