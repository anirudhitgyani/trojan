...
<img height="56px;" width="56px;" style="border-radius: 45px;"  src="<?php echo $RootPath; ?>upload_images/hr_images/<?php echo $row_user['ProfilePicture']; ?>" />
<?php } else { ?>
...
<table id="example" class="display" cellspacing="0" width="100%">
	...
	?>
            <tr>
                ...
                <td>Php Developer</td>
                <td><button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal_<?php echo $row_profile['ProfileID']; ?>">
  					Invite
					</button>
				</td>
			</tr>
...
<div class="modal fade" id="myModal_<?php echo $row_profile_1['ProfileID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <center><h5 style="display:none; color:green;" id="invite_success_<?php echo $row_profile_1['ProfileID']; ?>"> Invitation Successfully Send </h5> </center>
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="SendInvite(<?php echo $row_profile_1['ProfileID']; ?>);" class="btn btn-primary">Invite</button>
      </div>
    </div>
  </div>
</div>
...
function SendInvite(ProfileID){
	...
	$.ajax({
		...
		success: function(resp){
			if(resp=="0") {
				$('#invite_success_'+ProfileID).show();
				$('#invite_error_'+ProfileID).hide();
			} else {
				$('#invite_error_'+ProfileID).show();
				$('#invite_success_'+ProfileID).hide();
			}
		}
	});
}
