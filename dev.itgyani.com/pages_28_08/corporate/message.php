...
<table id="example" class="display" cellspacing="0" width="100%">
        ...
        ?>
           <?php if($row_invite['Message']!='') { ?>
           <?php if($row_invite['ReadByHR']=='1') { ?>
            <tr>
                ...
                <td><strong><?php echo $row_invite['SendDate']; ?></strong></td>
                <td><button type="button" onclick="ChangeStatus(<?php echo $row_invite['InviteID']; ?>);" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal_<?php echo $row_invite['InviteID']; ?>">
  					Read Message
					</button>
				</td>
			</tr>
            <?php } else { ?>
                ...
                <td><?php echo $row_invite['SendDate']; ?></td>
