...
<div class="form-group"><label>Student Email-id: </label><input name="email" id="email" type="text" class="form-input" onblur="if($('#email').val()=='') { $('#email').css('border','1px solid red'); } else { $('#email').css('border','1px solid #c4dee7'); }" /></div>
