...
<h2>My Course</h2>
<div id="DivCourse" class="box-content">
...
<h2>Video</h2>
<div id="ITGVideo" class="box-content" style="max-width:100%;min-width:100%;  ">
...
<a href="#" onclick="SetNextVideo();">Next Video</a>
<a href="#">Next Document</a>
<a href="#">Start Test</a>
<a href="#" onclick="GetNextTopic();">Next Topic</a>
</div> 
