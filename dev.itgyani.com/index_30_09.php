                ...
                <body>
                    ...
                    <div class="middle-content">
                        ...
                        <div class="service-section container">
                            <div class="row-fluid blue-back"><div class="col-sm-7 col-md-6 col-xs-12 pull-right text-right"><img src="images/student-images.jpg" /></div><div class="col-sm-5 col-md-6 col-xs-12">
                                    <div class="block-content students"><img src="images/student-icon.svg" />
                                        <h2>STUDENT</h2>
                                        <h5>KICKSTART YOUR CAREER.</h5>
                                        <p>Discover the career path best suited for you after learning of the various opportunities in IT.
                                            Choose with the help of counsellors who understand you and the IT Industry.
                                            Know by learnings from unlimited curated content to ensure you know your stuff.</p>
                                    </div>
                                </div></div>
                            <div class="row-fluid dark-back"><div class="col-sm-7 col-md-6 col-xs-12"><img src="images/corporate-images.jpg" /></div><div class="col-sm-5 col-md-6 col-xs-12">
                                    <div class="block-content corporate">
                                        <img src="images/corporate-icon.svg" /><h2>Corporate</h2>
                                        <h5>Get Pretrained candidates.</h5>
                                        <p>Discover by screening through thousands of candidate CVs
                                            Choose Fresher's by skill knowledge and business requirement.
                                            Know your hire… Tech and soft skills profiling.</p>
                                    </div>
                                </div></div>
                        </div>
                                    ...
                                    <div class="col-sm-12 col-xs-12 col-md-12">
                                        ...
                                        <div id="myCarousel" class="carousel slide">
                                            ...
                                            <div class="carousel-inner">
                                                ...
                                                <div class="item">
                                                    <div class="row-fluid">
                                                        <div class="col-sm-4 col-xs-4 col-md-4"><img class="img-circle" src="images/students/Ashu.png" /><p><strong>Ashutosh Khus</strong> <br/>KPIT</p></div>
                                                        <div class="col-sm-4 col-xs-4 col-md-4"><img class="img-circle" src="images/students/Krishna.png" /><p><strong>Krishna Bhardwaj </strong> <br/>BSNL</p></div>
                                                        <div class="col-sm-4 col-xs-4 col-md-4"><img class="img-circle" src="images/students/Rakhi.png" /><p><strong>Rakhi Pathak</strong> <br/> Oracle India Pvt Ltd</p></div>
                                                ...
                                                <img src="images/airvak1.PNG">
                                                    <img src="images/lapp.png">
                                                        <img src="images/yellow.png">
                                                            ...
                                                            <ul class="odd-menu">
                                                            <li><a href="<?php // echo $RootPath;  ?>pages/about/">About us</a></li>
                                                            <li><a href="#">The Team</a></li>
                                                            <li><a href="#">News</a></li>
                                                            <li><a href="#">Blog</a></li>
                                                            <li><a href="#">Jobs</a></li>
                                                            <li><a href="#">Legal</a></li>
                                                            <li><a href="<?php echo $RootPath;  ?>pages/policy/">Privacy Policy</a></li>
