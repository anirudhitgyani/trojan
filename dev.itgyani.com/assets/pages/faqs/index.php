 ...
 <div class="page-content-wrapper">
    ...
    <div class="portlet-body"><div class="dataTables_wrapper">
        ...
        <tbody>
            ...
            <tr style="cursor: pointer;"  onclick="GoToFaq(<?php echo $row_course['CourseID']; ?>);"  >
...
<script type="text/javascript">
function GoToFaq(CourseID){
  window.location.href = "<?php echo $AdminPath; ?>pages/faqs/faq.php?CourseID="+CourseID;  
}
