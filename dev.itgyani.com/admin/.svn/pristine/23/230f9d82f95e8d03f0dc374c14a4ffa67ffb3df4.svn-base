+function ( $, window) {
  ...
  function Filepicker(element, options) {
    ...
    function update() {
      ...
      $(input).prop('id', 'ITGTxtImageName');
      $(input).prop('placeholder', 'Click Here To Select Course Image ...');
    ...
    function renderPreview() {
      ...
      $(files).each(function() {
        ...
        var $thumbnail = $('<img id="ImgCourse" src="' + this.src + '" title="' + this.name + '" style="max-width: 100%; height: 100%;"/>');
