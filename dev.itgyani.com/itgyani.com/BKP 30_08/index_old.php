    ...
    border:1px solid #72C9F1;
        ...
        <div class="section__content clearfix">
		  ...
		  <div class="card effect__random col-md-4  col-xs-12" data-id="3">
			...
			<h3 class="back_two">Prerna</h3>
			<!-- <h5 class="back_two">Perl Developer</h5> -->
			<h3 class="back_two"><strong>LNT</strong></h3>
            </div>
            <div class="card__back">
             	<img src="images/Khushboo.png" alt="profile" class="img-responsive">
			<h3 class="back_one">Khushbu</h3>
	    	<!-- <h5 class="back_one">Java Developer</h5> -->
		   ...
		   <div class="card effect__random col-md-4" data-id="4">
			...
			<h3 class="back_two"></h3>
			<!-- <h5 class="back_two">Perl Developer</h5> -->
			<h3 class="back_two"><strong></strong></h3>
            </div>
            <div class="card__back">
                <img src="images/Sagar Sengar.png" alt="profile" class="img-responsive">
			<h3 class="back_one">Sagar Sengar</h3>
			<!-- <h5 class="back_one">Java Developer</h5> -->
			<h3 class="back_one"><strong></strong></h3>
            </div>
           </div><!-- /card -->
		  
		   <div class="card effect__random col-md-4" data-id="5">
            <div class="card__front">
             <img src="images/1.png" alt="profile" class="img-responsive">
			<h3 class="back_two">Arnav Raut</h3>
			<!-- <h5 class="back_two">Perl Developer</h5> -->
			<h3 class="back_two"><strong>Infosys</strong></h3>
            </div>
            <div class="card__back">
             	<img src="images/2.png" alt="profile" class="img-responsive">
			<h3 class="back_one">Lokesh Roy</h3>
			<!-- <h5 class="back_one">Java Developer</h5> -->
			<h3 class="back_one"><strong>3DPLM</strong></h3>
            </div>
          </div>
		  ...
		  <div class="card effect__random col-md-4" data-id="6">
            <div class="card__front">
             <img src="images/1.png" alt="profile" class="img-responsive">
			<h3 class="back_two">Ganesh Kolte</h3>
			<!-- <h5 class="back_two">Perl Developer</h5> -->
			<h3 class="back_two"><strong>Persistant</strong></h3>
            </div>
            <div class="card__back">
             	<img src="images/2.png" alt="profile" class="img-responsive">
			<h3 class="back_one">Swapnil Konde</h3>
			<!-- <h5 class="back_one">Java Developer</h5> -->
			<h3 class="back_one"><strong>Fujitsu</strong></h3>
            </div>
          </div>
		  ...
		  <div class="card effect__random col-md-4" data-id="7">
            <div class="card__front">
             <img src="images/1.png" alt="profile" class="img-responsive">
			<h3 class="back_two">Sachin Kale</h3>
			<!-- <h5 class="back_two">Perl Developer</h5> -->
			<h3 class="back_two"><strong>Infosys</strong></h3>
            </div>
            <div class="card__back">
             	<img src="images/2.png" alt="profile" class="img-responsive">
			<h3 class="back_one">Suhas Jadhav</h3>
			<!-- <h5 class="back_one">Java Developer</h5> -->
			<h3 class="back_one"><strong>Aptara</strong></h3>
            </div>
          </div>
		  ...
		  <div class="card effect__random col-md-4" data-id="8">
            <div class="card__front">
             <img src="images/1.png" alt="profile" class="img-responsive">
			<h3 class="back_two">Vishal Hole</h3>
			<!-- <h5 class="back_two">Perl Developer</h5> -->
			<h3 class="back_two"><strong>Capegemini</strong></h3>
            </div>
            <div class="card__back">
             	<img src="images/2.png" alt="profile" class="img-responsive">
			<h3 class="back_one">Sandip Memane</h3>
			<!-- <h5 class="back_one">Java Developer</h5> -->
			<h3 class="back_one"><strong>Raptech</strong></h3>
            </div>
          </div>
          </div>
