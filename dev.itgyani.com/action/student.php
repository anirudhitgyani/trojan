...
Apart from this you can enjoy the following benefits as part of the program. </p>
	...
	if($action=='login') {
		...
		if(empty($row)) {
			...
			$_SESSION['ProfileEmail'] = $_REQUEST['user_name'];
			$_SESSION['ProfilePassword'] = $_REQUEST['password'];
			echo "0";
			exit();
		} else {
			if($row['IsActive']=='0') {
				...
				exit();
                                ...
                                if($row['LastCourseID']=='0' && $row['LastTopicID']=='0' ) {
                                    ...
                                    $_SESSION['stud_id'] = $row['ProfileID'];
                                    $_SESSION['LastCourseID'] = $row['LastCourseID'];
                                    $_SESSION['LastTopicID'] = $row['LastTopicID'];
                                    echo "3";
                                    //header("location:".$RootPath."pages/student/dashboard.php?CourseID=".$row['LastCourseID']."&TopicID=".$row['LastTopicID']);
                                    exit();
                                }
			}
	...
	if($action=="biodata") {
		...
		$sql = mysql_query("select * from `biodata` where ProfileID = '".$_SESSION['stud_id']."' ") or die(mysql_error());
	...
	if($action=="completed_test"){
		...
		if($total_test_rows!='0') {
			...
			$sql = mysql_query("insert into `test_detail` set TopicID = '".$TopicID."' ,  CourseID = '".$CourseID."' , ProfileID = '".$_SESSION['stud_id']."' , IsCompleted = '1' , TestDate = '".$created_date."' , NextTopicID = '".$NextTopicID."' , Status = '1' ");
		exit();
		}
		exit();
	}
...
<div style="margin-top: 20px;" id="Question_Div" >
    ...
    <input type="hidden" name="NextQuestionID" id="NextQuestionID" value="<?php echo $NextQuestionID; ?>" />
     ...
     <table>
         ...
         <tr>
             <td style="width: 10%;" ><input type="radio" name="answer_1" id="answer_1" onclick="SaveAnswer('1','<?php echo $row_test['QuestionSetID']; ?>');" value="<?php echo $row_test['Answer01'] ?>" /></td>
             <td style="width: 60%;" ><?php echo $row_test['Answer01'] ?></td>
             <td style="width: 20%;" ><img style="display:none;" class="right_img_class" id="right_img_1" src="<?php echo $RootPath; ?>images/right.png" height="30px;" width="30px;" />
                 <img style="display:none;" id="wrong_img_1" class="wrong_img_class" src="<?php echo $RootPath; ?>images/wrong.png" height="30px;" width="30px;" /> </td>
         </tr>
         <?php } ?>
         <?php if($row_test['Answer02']) { ?>
         <tr>
             <td style="width: 10%;" ><input type="radio" name="answer_2" id="answer_2" onclick="SaveAnswer('2','<?php echo $row_test['QuestionSetID']; ?>');" value="<?php echo $row_test['Answer02'] ?>" /></td>
             <td style="width: 60%;" > <?php echo $row_test['Answer02'] ?></td>
             <td style="width: 20%;" ><img style="display:none;" class="right_img_class" id="right_img_2" src="<?php echo $RootPath; ?>images/right.png" height="30px;" width="30px;" />
                 <img style="display:none;" id="wrong_img_2" class="wrong_img_class" src="<?php echo $RootPath; ?>images/wrong.png" height="30px;" width="30px;" /> </td>
         </tr>
         <?php } ?>
         <?php if($row_test['Answer03']) { ?>
         <tr>
             <td style="width: 10%;" ><input type="radio" name="answer_3" id="answer_3" onclick="SaveAnswer('3','<?php echo $row_test['QuestionSetID']; ?>');" value="<?php echo $row_test['Answer03'] ?>" /></td>
             <td style="width: 60%;" ><?php echo $row_test['Answer03'] ?></td>
             <td style="width: 20%;" ><img style="display:none;" class="right_img_class" id="right_img_3" src="<?php echo $RootPath; ?>images/right.png" height="30px;" width="30px;" />
                 <img style="display:none;" id="wrong_img_3" class="wrong_img_class" src="<?php echo $RootPath; ?>images/wrong.png" height="30px;" width="30px;" /> </td>
         </tr>
         <?php } ?>
         <?php if($row_test['Answer04']) { ?>
         <tr>
             <td style="width: 10%;" ><input type="radio" name="answer_4" id="answer_4" onclick="SaveAnswer('4','<?php echo $row_test['QuestionSetID']; ?>');" value="<?php echo $row_test['Answer04'] ?>" /> </td>
             <td style="width: 60%;" ><?php echo $row_test['Answer04'] ?></td>
             <td style="width: 20%;" ><img style="display:none;" class="right_img_class" id="right_img_4" src="<?php echo $RootPath; ?>images/right.png" height="30px;" width="30px;" />
                 <img style="display:none;" id="wrong_img_4" class="wrong_img_class" src="<?php echo $RootPath; ?>images/wrong.png" height="30px;" width="30px;" /> </td>
         </tr>
         <?php } ?>
     </table> 
			<!--option 1
		...
		<input type="radio" name="answer_1" id="answer_1" onclick="SaveAnswer('1','<?php echo $row_test['QuestionSetID']; ?>');" value="<?php echo $row_test['Answer01'] ?>" /> <?php echo $row_test['Answer01'] ?> <br/><br/>
            ...
            <?php if($row_test['Answer04']) { ?>  
                    <input type="radio" name="answer_4" id="answer_4" onclick="SaveAnswer('4','<?php echo $row_test['QuestionSetID']; ?>');" value="<?php echo $row_test['Answer04'] ?>" /> <?php echo $row_test['Answer04'] ?><span> <br/><br/>
                    
            <?php } ?>    -->
                      
<img style="display:none;" id="right_img" src="<?php echo $RootPath; ?>images/right.png" height="30px;" width="30px;" />
<img style="display:none;" id="wrong_img" src="<?php echo $RootPath; ?>images/wrong.png" height="30px;" width="30px;" />                        
...
<div  style="margin-top: 30px;"  class="buttons-box text-center">
    ...
    <input type="button" onclick="RestartTest();" class="green-butt green-back" value="Restart Test" /></div>
        ...
        if($action="no_test"){
            ...
            $CourseID = $_REQUEST['CourseID'];
            $NextTopicID = $_REQUEST['NextTopicID'];
            $NextCourseID = $_REQUEST['NextCourseID'];
            $created_date = date('Y-m-d H:i:s');
            
//            $sql_test_result = mysql_query("select * from `test_detail` where ProfileID = '".$_SESSION['stud_id']."' AND CourseID = '".$CourseID."' AND TopicID = '".$TopicID."'  ");
//            $total_test_result = mysql_num_rows($sql_test_result);
//            if($total_test_result!='0'){
//                $sql_test = mysql_query("update `test_detail` set Status = '1' , IsCompleted = '1' , TestDate = '".$created_date."' where ProfileID = '".$_SESSION['stud_id']."' AND CourseID = '".$CourseID."' AND TopicID = '".$TopicID."' ");
//            } else {
//                $sql_test = mysql_query("insert into `test_detail` set ProfileID = '".$_SESSION['stud_id']."' , CourseID = '".$CourseID."' , TopicID = '".$TopicID."' , IsCompleted = '1' , NextTopicID = '".$NextTopicID."' , NextCourseID = '".$NextCourseID."' , TestDate = '".$created_date."' , Status = '1' ");
//            } 
