...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
  ...
  add_image_size('home-image',470,300,true);
  add_image_size('home-small-image',219,166,true);
  add_image_size('blog-image',357,265,true);
  add_image_size('slide-image',2500,600,true);
}
...
class template1_search extends WP_Widget {
	function template1_search() {
		parent::WP_Widget(false, 'LargeSlider Search');
	}
