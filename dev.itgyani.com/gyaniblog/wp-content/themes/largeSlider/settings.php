<?php
$themename = "Large Slider";
$shortname = "ultra_simple";
$settings_list = array(
    'custom_logo_url',
...
<tr>
  ...
  <td><input type="text" name="custom_logo_url" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_custom_logo_url',''))); ?>" /><br /><small><a href="<?php bloginfo('url'); ?>/wp-admin/media-new.php" target="_blank">Upload your logo</a> (290px wide x 60px high)</small></td>
</tr>
<tr>
