...
define('SECRET_SALT','2C5109C1BBA3FE');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','sagar@itgyani.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost'); 
define('DBNAME','itgyani_tickets');
define('DBUSER','itgyani_tickets');
define('DBPASS','tickets');

#Table prefix
define('TABLE_PREFIX','ostm_');
