...
Looking forward to serving you… </p>
	...
	if($action=="edit_profile") {
		...
		$sql = mysql_query("update `profile` set ProfileName = '".$ProfileName."' , ProfileLastName = '".$ProfileLastName."' , ProfileFirstName = '".$ProfileFirstName."' , ProfileDBO = '".$NewDBO."' , ProfileGender = '".$ProfileGender."' , ProfileEmail = '".$ProfileEmail."' , ProfileMobile = '".$ProfileMobile."' , ProfileCompanyName = '".$ProfileCompanyName."' , ProfilePincode = '".$ProfilePincode."' , ProfileAddress = '".$ProfileAddress."' ,ProfileAddress1 = '".$ProfileAddress1."' , ProfileCountry = '".$ProfileCountry."' , StateID = '".$StateID."' , CityID = '".$CityID."' , UpdateUserTime = '".$created_date."' where ProfileID = '".$ProfileID."' ") or die(mysql_error());
	...
	if($action=="change_image") {
		...
		$_SESSION['Success'] = "Your Profile Picture Successfully Updated...";
		header("location:".$RootPath."pages/corporate/edit_profile.php");
		exit();
	}
